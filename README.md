...
Chrome 擴充功能,在 Spotify 網頁版的日文歌詞旁顯示羅馬拼音,方便不懂假名的人跟唱。
...
然後到 `chrome://extensions` → 開啟右上角「開發人員模式」→「載入未封裝項目」→ 選擇本專案的 **`dist/`** 資料夾。

打開 [open.spotify.com](https://open.spotify.com),播放日文歌並開啟歌詞面板,每行歌詞下方就會出現綠色的羅馬拼音。
